...
public:
    ...
    explicit FilesBase(QObject *parent = nullptr);
    virtual ~FilesBase() override;
...
public:
    ...
    int append(FileItem* pPacket);
    FileItem* packet(int index) const;
...
signals:
    ...
    void filesLoaded(const std::vector<FileItem*>& list);

public slots:

    void appendToBase(FileItem* pPacket);
